...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .welcome-card { position: relative; width: 520px; max-width: 100%; border-radius: var(--radius-xl); opacity: 0; transform: translateY(30px); animation: fadeUp 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards; z-index: 10; }
        ...
        .faq-item { background: var(--surface-1); border: 1px solid var(--border-subtle); border-radius: 16px; padding: 16px; margin-bottom: 12px; transition: all 0.3s ease; cursor: pointer; }
        .faq-item:hover { background: var(--surface-2); border-color: var(--primary-light); transform: scale(1.01); }
    ...
    <div class="welcome-card" id="welcome-card">
        ...
        <div class="card-surface">
            <header class="text-center mb-8">
                ...
                <h1 class="brand-name">PUSAT BANTUAN</h1>
                <p class="text-xs tracking-[0.3em] text-white/40 uppercase font-medium">Bantuan & Informasi</p>
            </header>

            <div class="space-y-3 mb-8">
                <div class="faq-item group">
                    <div class="flex items-center justify-between">
                        <h3 class="text-white text-sm font-semibold group-hover:text-primary-light transition-colors">Bagaimana cara mendaftar event?</h3>
                        <svg class="w-4 h-4 text-white/20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                    </div>
                </div>

                <div class="faq-item group">
                    <div class="flex items-center justify-between">
                        <h3 class="text-white text-sm font-semibold group-hover:text-primary-light transition-colors">Apakah ada biaya pendaftaran?</h3>
                        <svg class="w-4 h-4 text-white/20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                    </div>
                </div>
                ...
                <div class="faq-item group">
                    <div class="flex items-center justify-between">
                        <h3 class="text-white text-sm font-semibold group-hover:text-primary-light transition-colors">Bagaimana cara menghubungi admin?</h3>
                        <svg class="w-4 h-4 text-white/20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                    </div>
                </div>
            </div>

            <div class="p-6 bg-primary/10 border border-primary/20 rounded-2xl mb-8 text-center">
                <p class="text-white/70 text-xs mb-4">Masih butuh bantuan lebih lanjut?</p>
                <a href="mailto:admin@amikomeventhub.com" class="text-sm font-bold text-primary-light hover:text-white transition-colors underline decoration-primary/40 underline-offset-4">Hubungi Support Kami</a>
            </div>
